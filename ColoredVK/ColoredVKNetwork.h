...
- (void)sendRequestWithMethod:(NSString *)method url:(NSString *)url parameters:(id)parameters 
                      success:(void(^)(NSURLRequest *request, NSHTTPURLResponse *httpResponse, NSData *rawData))success 
...
- (void)sendRequest:(NSURLRequest *)request 
            success:(void(^)(NSURLRequest *httpRequest, NSHTTPURLResponse *httpResponse, NSData *rawData))success 
            failure:(void(^)(NSURLRequest *httpRequest, NSHTTPURLResponse *httpResponse, NSError *error))failure;
