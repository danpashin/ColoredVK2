...
cp -r ColoredVK.bundle ~/Desktop/vkUnarch/Payload/vkclient.app/
cp ${BUILT_PRODUCTS_DIR}/ColoredVK.dylib ~/Desktop/vkUnarch/Payload/vkclient.app/ColoredVK.bundle/
cd ~/Desktop/vkUnarch
